...
//	$(".del_proPulTopHid").show();
	$(".del_kong").show();
},function(){
//	$(".del_proPulTopHid").hide();
	$(".del_kong").hide();
})
...
class Cart{
        ...
        goodsAdd(){
           //商品数量
            let oGoodsNum = document.getElementById("goods-num1"); 
            //修改数量
        ...
        addGoods(){
        	//获取需要添加商品名称
	        let oGoodsName = document.getElementById("goods1");
	        //商品数量
            let oGoodsNum = document.getElementById("goods-num1").value;
             if(oGoodsNum >1){
            	$("#pro-quantity-minus").css({ cursor:"pointer", color: "#777"});
            } 
	        let ls = localStorage; 
        	...
        	//获取需要添加商品单价
	        let oGoodsPrice = document.getElementById("pro-price1");
        ...
        eventBind(){
            ...
            let oAddgoods1 = document.getElementById("add-goods1");
            let that = this;
...
//  详情页滚动条
    $(function (){
	    var topHeight = $(".xl_top").height();
	    var navHeight = $(".xl_honorNav").height();
	    var smaHeight = $(".xl_smallNav").height();
	    var rigHeight = $('.det_proRigCon').height();
        var theight = topHeight + navHeight + smaHeight;
        var fheight = $(document).height()- theight - rigHeight   // 获取底部及底部上方边距的总高度
